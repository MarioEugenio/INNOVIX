...
{ 
    public class TbLocalidadeService : ServiceCRUD<TbLocalidade>, ITbLocalidadeService
    {
		public TbLocalidadeService(ITbLocalidadeRepository repository) : base(repository) { }
	}
}