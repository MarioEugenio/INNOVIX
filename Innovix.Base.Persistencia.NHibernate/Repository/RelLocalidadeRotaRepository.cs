...
{ 
    public class RelLocalidadeRotaRepository : RepositoryNHibernate<RelLocalidadeRota>, IRelLocalidadeRotaRepository
    {
		public RelLocalidadeRotaRepository(ISession session) : base(session) { }
