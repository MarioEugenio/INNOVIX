...
{ 
    public class TbEquipamentoRepository : RepositoryNHibernate<TbEquipamento>, ITbEquipamentoRepository
    {
		public TbEquipamentoRepository(ISession session) : base(session) { }
