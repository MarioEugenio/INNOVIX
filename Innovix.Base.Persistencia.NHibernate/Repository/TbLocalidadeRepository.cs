...
{ 
    public class TbLocalidadeRepository : RepositoryNHibernate<TbLocalidade>, ITbLocalidadeRepository
    {
		public TbLocalidadeRepository(ISession session) : base(session) { }
